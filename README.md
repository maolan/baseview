...
`baseview` abstracts the platform-specific windowing APIs (winapi, xcb) into a platform-independent API, but otherwise gets out of your way so you can write plugin UIs.
